...
<h2><strong>stockists</strong> List </h2>
...
<thead>
<tr>
<th class="text-center">stockists Name</th>
...
<a href="{{route('stokistedit',array('id' => $row->id))}}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
...
@else
<a href="{{route('stokistdelete',array('id' => $row->id))}}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
@endif
</div>
</td>
</tr>
